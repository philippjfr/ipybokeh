...
# -*- coding: utf-8 -*-
#
# ipybokeh documentation build configuration file
#
...
project = 'ipybokeh'
copyright = '2019, Philipp Rudiger'
...
_version_py = os.path.join(repo, 'ipybokeh', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ipybokeh.tex', 'ipybokeh Documentation',
     'Philipp Rudiger', 'manual'),
]
